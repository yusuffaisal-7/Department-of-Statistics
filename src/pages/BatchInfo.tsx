  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-3xl font-bold mb-4">Batch Information</h1>
        ...
        >
          <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
            <Users className="w-10 h-10 text-teal-600 mr-4" />
            <div>
              <h3 className="text-xl font-semibold">{batches.reduce((acc, batch) => acc + batch.totalStudents, 0)}</h3>
              <p className="text-gray-600">Total Students</p>
            </div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
            <GraduationCap className="w-10 h-10 text-teal-600 mr-4" />
            <div>
              <h3 className="text-xl font-semibold">{batches.length}</h3>
              <p className="text-gray-600">Total Batches</p>
            </div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md flex items-center">
            <Calendar className="w-10 h-10 text-teal-600 mr-4" />
            <div>
              <h3 className="text-xl font-semibold">{batches[0].session.split('-')[0]} - Present</h3>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Male</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Female</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Graduation Year</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Batch Advisor</th>
